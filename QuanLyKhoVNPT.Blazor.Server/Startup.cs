...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<QuanLyKhoVNPTBlazorApplication>();
            builder.Modules
                ...
                .AddViewVariants()
                .Add<QuanLyKhoVNPT.Module.QuanLyKhoVNPTModule>()
            	.Add<QuanLyKhoVNPTBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(QuanLyKhoVNPT.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(QuanLyKhoVNPT.Module.BusinessObjects.ApplicationUserLoginInfo);
                    ...
                    options.Events.OnAuthenticated = (externalAuthenticationContext) => {
                        ...
                        externalAuthenticationContext.Principal.Identity.AuthenticationType != SecurityDefaults.WindowsAuthentication && !(externalAuthenticationContext.Principal is WindowsPrincipal)) {
                            ...
                            object CreateApplicationUser(string userName, string providerUserId) {
                                if(objectSpace.FirstOrDefault<QuanLyKhoVNPT.Module.BusinessObjects.ApplicationUser>(user => user.UserName == userName) != null) {
                                    throw new ArgumentException($"The username ('{userName}') was already registered within the system");
                                }
                                var user = objectSpace.CreateObject<QuanLyKhoVNPT.Module.BusinessObjects.ApplicationUser>();
                            ...
                            ISecurityUserLoginInfo FindUserLoginInfo(string loginProviderName, string providerUserId) {
                                return objectSpace.FirstOrDefault<QuanLyKhoVNPT.Module.BusinessObjects.ApplicationUserLoginInfo>(userLoginInfo =>
